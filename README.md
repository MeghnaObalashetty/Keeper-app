...
//3. Create a Header.jsx component that renders a <header> element to show the Keeper 
//App name in an <h1>.
//4. Create a Footer.jsx component that renders a <footer> element to show a 
//copyright message in a <p> with a dynamically updated year.
//5. Create a Note.jsx component to show a <div> element with a <h1> for a titleand 
//<p> for the content.
